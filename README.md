...
## 3. New version
We have launched a new method and placed it in the directory `/analysisUtil_new`. It is currently being tested. The usage method is in the `/analysisUtil_new/readme.md`.
